...
import com.iftm.startexample.messages.RabbitMqSendLog;
...
public class EmployeeService {
    ...
    public ResponseEntity<EmployeeDTO> save(EmployeeDTO employeeDTO) {
        ...
        var dbEmployeeDTO = new EmployeeDTO(repository.save(employeeDTO.toEmployee()));

        rabbitMqSendLog.sendLog(new LogDTO<EmployeeDTO>("created", dbEmployeeDTO));

        return ResponseEntity.ok(dbEmployeeDTO);
    }
